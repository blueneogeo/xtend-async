...
public interface StreamHandler<I extends Object, O extends Object> {
  /**
   * handle each incoming value. remember to call stream.next after handling a value!
   */
  public abstract void each(final Procedure2<? super I, ? super O> handler);
  
  /**
   * handle each incoming error. remember to call stream.next after handling an error!
   */
  public abstract void error(final Procedure2<? super I, ? super Throwable> handler);
  
  /**
   * handle each incoming finish. remember to call stream.next after handling a finish!
   */
  public abstract void finish(final Procedure2<? super I, ? super Integer> handler);
