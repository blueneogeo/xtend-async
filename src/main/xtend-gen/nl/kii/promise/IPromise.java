...
public interface IPromise<I extends Object, O extends Object> extends Procedure1<Entry<I, O>> {
  public abstract IPromise<I, ?> getInput();
  ...
  public abstract IPromise<I, O> on(final Class<? extends Throwable> exceptionType, final boolean swallow, final Procedure2<I, Throwable> errorFn);
