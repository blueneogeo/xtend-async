...
public class TestPromisePairExt {
  ...
  public void testEachWithPairParams() {
    ...
    StreamPairExtensions.<Integer, Integer>each(p, _function);
  ...
  public void testAsyncWithPairParams() {
    ...
    final Stream<Integer> asynced = StreamPairExtensions.<Integer, Integer, Integer>async(p, _function);
  ...
  public void testAsyncPair() {
    ...
    Stream<Pair<Integer,Integer>> _asyncToPair = StreamPairExtensions.<Integer, Integer, Integer>asyncToPair(p, _function);
    ...
    final Stream<Pair<Integer,Integer>> asynced = StreamPairExtensions.<Integer, Integer, Integer, Integer>asyncToPair(_asyncToPair, _function_1);
