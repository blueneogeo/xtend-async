...
public class TestPromise {
  ...
  public void silentlyFailsWithoutHandler() {
    ...
    promise.set(Integer.valueOf(1));
    final Procedure1<Integer> _function = (Integer it) -> {
      this.setResult(Integer.valueOf(((it).intValue() / 0)));
    };
    promise.then(_function);
    Integer _result_1 = this.getResult();
    JUnitExtensions.<Integer>operator_spaceship(
  ...
  public void canCatchErrorsBeforeListening() {
    ...
    final Procedure1<Throwable> _function = (Throwable it) -> {
      this.setResult(Integer.valueOf(1));
    };
  ...
  public void testTaskChain() {
    ...
    final Function1<Boolean, Task> _function = (Boolean it) -> {
    ...
    final Function1<Boolean, Task> _function_1 = (Boolean it) -> {
      return this.sayHello();
    };
    ...
    final Function1<Integer, Promise<Integer>> _function_6 = (Integer it) -> {
      try {
        Promise<Integer> _xblockexpression = null;
        {
          ...
          _xblockexpression = this.addOne((it).intValue());
        }
  ...
  public Promise<IPromise<Integer, Integer>> addOne(final int n, final Promise<Integer> promise) {
    final Callable<IPromise<Integer, Integer>> _function = () -> {
  ...
  public void testPromiseWithLaterError2() {
    ...
    Task _then = _map.then(_function_1);
    final Procedure1<Throwable> _function_2 = (Throwable it) -> {
      this.setFoundError(Boolean.valueOf(true));
    };
