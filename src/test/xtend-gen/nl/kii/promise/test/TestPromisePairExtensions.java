...
public class TestPromisePairExtensions {
  ...
  public void testThenWithPairParams() {
    ...
    Promise<Pair<Integer, Integer>> _promisePair = PromiseExtensions.<Integer, Integer>promisePair(_mappedTo);
    Pair<Integer, Integer> _mappedTo_1 = Pair.<Integer, Integer>of(Integer.valueOf(1), Integer.valueOf(2));
    final IPromise<Pair<Integer, Integer>> p = PromiseExtensions.<Pair<Integer, Integer>>operator_doubleLessThan(_promisePair, _mappedTo_1);
    ...
    PromiseExtensions.<Integer, Integer>then(p, _function);
  ...
  public void testMapWithPairs() {
    ...
    final Promise<Pair<Integer, Integer>> asynced = PromiseExtensions.<Integer, Integer, Pair<Integer, Integer>>map(_map, _function_1);
